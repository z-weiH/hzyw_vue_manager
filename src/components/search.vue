    ...
    <el-col class="mb-10" :span="searchItem.colSpan ? searchItem.colSpan : 6">
      <div v-if="searchItem.type == 'rangeText'" class="group_labels">
        <label :for="searchItem.labTid && searchItem.labTid()" class="groupIpt_lab">
              <el-input type="number" :id="searchItem.labTid && searchItem.labTid()" v-if="searchItem.type == 'rangeText' || !searchItem.type" v-model="item[searchItem.property]" :placeholder="searchItem.placeholder" @keyup.native="valueChange"></el-input>
