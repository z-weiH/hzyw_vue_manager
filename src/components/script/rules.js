...
export const RULES = {
  ...
  phone: {required : true , pattern : Regs['telOrPhone'] , message : '格式不正确'}, // 固定电话 或 手机号
  email: {required : true , pattern : Regs['email'] , message : '格式不正确'},// 邮箱
  certificate: {required : true , pattern : Regs['certificate'] , message : '格式不正确'},// 身份证
