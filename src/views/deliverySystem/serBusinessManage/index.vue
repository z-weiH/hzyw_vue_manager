<template>
    ...
    <div class="wsbodyhead">
      <a>所在位置</a>
      <a href="javascript:;" class="aside_tit">业务管理</a>
    </div>
		<div class="item-search">
      <el-form :inline="true" ref="ruleForm" :model="ruleForm" label-width="0px">
        <el-form-item label=" " prop="keyWords">
          <el-input @keyup.native.enter="handleSearch" v-model.trim="ruleForm.keyWords" placeholder="请输入业务编码、业务名称"></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="busiInfo" label="业务描述"></el-table-column>
    ...
    mounted() {
      ...
      handleDelete(row) {
        this.$confirm('确认删除?', '提示', {
          ...
          this.$http({
            method : 'post',
            url : '/busiManagement/deletedBusiInfoByBusiCode.htm',
            data : {
