...
<div class="content">
   <div class='content'>
        ...
        <div class='item-table'>
           <table-component  :pager="pager"  @refreshList="doQuery(this.queryUrl, this.searchItem)"  :table-data="tableData"  :column-define="columnDefine" :actions="actions"></table-component>
        </div>
        <customer-allot-create  :item="searchItem" :edit-state="editState"></customer-allot-create>
   </div>
</div>
</template>
