  ...
  <div class="review-case-list">
    ...
    <div class="item-table">
      ...
      >
        ...
        <el-table-column prop="productName" label="产品模板" width="150px">
          <template slot-scope="scope">
        ...
        <el-table-column prop="resPhone" label="申请立案时间" width="150px"></el-table-column>
        <el-table-column prop="resPhone" label="初审人" width="150px"></el-table-column>
        <el-table-column prop="resPhone" label="复审人" width="150px"></el-table-column>
