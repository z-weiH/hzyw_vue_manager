<template>
  <div class="review-case-list-dialog">
    <el-dialog
      title="分配案件"
    ...
    >
      <div class="m-conetnt">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
          ...
          <el-form-item label="产品模版" prop="productId">
            <el-select
              style="width:100%"
          ...
          <div>
            <span class="icon-sign">初审分配</span>
          </div>
          ...
          <div>
            <span class="icon-sign">复审人</span>
          </div>

          <div class="screening-results">
            <template v-if="ruleForm.allocationList[0].disabled === false">
              <span>--</span>
            </template>
            <template v-else>
              ...
              <template>
                <span>未指定</span>
                <el-button @click="handleSet" class="ml-10" type="text">设置</el-button>
              </template>
            </template>
          </div>
