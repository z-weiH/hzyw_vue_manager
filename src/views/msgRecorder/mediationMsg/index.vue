  ...
  data() {
    return {
      ...
      columnDefine: [
        ...
        {label:'互金企业',property: 'platName',width: 130},
        {label:'申请人',property: 'applicants',width: 100},
        {label:'被申请人',property: 'respondents',width: 100},
        {label:'被申请人手机',property: 'resPhone',width: 120},
        {label:'案件阶段',property: 'caseProcessDesc', width: 100},
        {label:'案件状态',property: 'caseStatusDesc', width: 100},
        {label:'提交日期',property: 'submitTime', width: 140},
        {label:'标的金额',property: 'amtBorrow',width: 100},
        {label:'应裁情况',property: 'decideStatus', width: 100},
        {label:'短信送达',property: 'messageDelivery',width: 100},
        {label:'短链查看',property: 'shortChainView',width: 100},
      ],
    };
  },
  computed: {
