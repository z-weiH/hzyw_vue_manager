<template>
  <div class="balance-query">
    ...
    <div class="item-title">账户余额查询</div>
    ...
    <div class="item-table">
      <el-table :data="tableData" border>
        ...
        <el-table-column prop="serverFeeRechargeAll" label="累计充值服务费(元)"></el-table-column>
        <el-table-column prop="giftServerFeeTotal" label="累计赠送服务费(元)"></el-table-column>
        <!-- <el-table-column prop="ticketAmtTotal" label="累计充值仲券(张)">
          <template slot-scope="scope">
  ...
  methods: {
    ...
    handleDetail(row) {
      this.$router.push({
        ...
        query: { clientCode: row.clientCode, settleType: row.settleType }
      });
    },
    //赠券详情
    handleInfo(row) {
