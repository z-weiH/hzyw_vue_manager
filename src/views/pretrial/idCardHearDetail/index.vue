<template>
  ...
  >
    ...
    <el-dialog
      :visible.sync="respondentEditFlag"
      v-dialogDrag
      title="信息修正"
      width="545px"
      center>
      ...
      <span slot="footer" class="dialog-footer">
          ...
          <el-button @click="respondentEditFlag = false">取 消</el-button>
        </span>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      respondentEditItems:[
        {type: 'text', property:'resName', label: '姓名',rule:'require', hidden:() => this.respondentEidtConfig.nameStatus === 1},
        {type: 'select', property:'resSex', label: '性别', rule:'require',options: [{label:'女',value: 0},{label:'男',value: 1}],hidden:() => this.respondentEidtConfig.sexStatus === 1},
        {type: 'select', property:'resNation', label: '民族', options: [],rule:'require',hidden:() => this.respondentEidtConfig.nationStatus === 1},
        {type: 'text', property:'resIdaddress', label: '住址', rule:'require',hidden:() => this.respondentEidtConfig.idaddressStatus === 1},
        {type: 'text', property:'resIdcard', label: '证号',rule:'require,certificate',hidden:() => this.respondentEidtConfig.idcardStatus === 1},
      ],
