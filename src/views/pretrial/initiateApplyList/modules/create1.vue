<template>
 <div>
   ...
   <el-dialog
  title="提示"
  :visible.sync="editState1"
  width="30%"
  >
  <ul>
     <li>申请<span class="f_orange">{{zqdata.totalAmt}}</span>件案件，共需消耗仲券<span class="f_orange">{{zqdata.factCaseCount}}</span>张，受理费<span>{{zqdata.totalAmt}}</span>元。</li>
...
import { URL_JSON } from "../../../../components/script/url_json";
 export default {
   ...
   methods:{
     confirmApCase(){
       this.$http.post(URL_JSON['confirmApplyCase'],this.item)
       .then(res=>{
