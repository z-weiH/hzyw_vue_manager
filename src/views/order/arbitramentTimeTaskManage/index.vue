  ...
  <div class="arbitrament-time-task-manage">
    ...
    <div class="item-table">
      ...
      >
        ...
        <el-table-column prop="busiCode" label="业务编码">
          <template slot-scope="scope">
            <el-tooltip :content="scope.row.busiCode" placement="top-start">
              <span class="ellipsis" style="max-width:104px;">{{scope.row.busiCode}}</span>
            </el-tooltip>
          </template>
        </el-table-column>
